...
Figura(nome:"Mingle",
       ...
       descricao:"O Mingle se destaca por fazer o dobro do trabalho na metade do tempo, com extrema precisão. Essas habilidades são úteis para ela em sua funcão de Analista de Dados Sênior para uma empresa internacional de computacão em nuvem. Ela também tem uma propensão para danca de salão, danca de linha e praticamente qualquer tipo de atividade que a deixe dancar ao som da música",
       vidas:2,
       potencia:0.42
),
Figura(nome: "Yodel",
       ...
       descricao: "Yodel cresceu em uma familia de cantores e faladores e nunca conseguia falar uma palavra. Então, seu vasto talento para o yodeling surgiu. Agora ele se apresenta para fãs adoradores em todo o mundo, e sempre tem a voz mais alta da mesa de jantar. Aliás, ele também é um grande defensor da neutralidade da rede e passa incontáveis horas moderando um fórum na internet dedicado exclusivamente a esse assunto",
       vidas:4,
       potencia:0.19
),
Figura(nome: "Squido",
